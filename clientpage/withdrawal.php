...
<div class="row">
    <div class="container col-xxl-6 col-xl-6 col-lg-7 col-md-8 col-sm-9 mb-3 justify-content-center">
        <form action="include/with.php" method="post" class="needs-validation" novalidate id="forms">
            <div class="card shadow justify-content-center">
                ...
                <div class="card-body">
                    ...
                    <center>
                    <div class="form-group mb-3">
                        <button type="submit" name="with_btn" class="btn btn-outline-primary">Withdraw</button>
                    </div>
                    <?php
                        if(isset($_SESSION['message']) && $_SESSION['message'] !='')
                        {
                            echo '<div class="justify-content-center alert alert-danger ms-3" role="alert">'.$_SESSION['message'].'</div>';
